...
(function ($) {
    function init(param, obj) {
                ...
                default:
                    try {
                       /* resultPageCount = $(data).find(":hidden[id='" + pageCountId + "']").val();*/
                        $("#temp").html(data);
                        resultPageCount = $("#resultPageCount").val();
                        $("#temp").html("");
                    } catch (e) {
        ...
        var defaults = {currPage: 1, pageCount: 10, pageNumber: 5, cssStyle: "badoo", debug: !1, ajax: {on: !1, type: "POST", pageCountId: "pageCount", url: "jsonTest.php", dataType: "json", param: !1, onClick: function () {
            return!1
        }, ajaxStart: function () {
            return!1
        }, ajaxStop: function () {
            ...
            return!1
        }}, panel: {first: "\u9996\u9875", last: "\u5c3e\u9875", next: "\u4e0b\u4e00\u9875", prev: "\u4e0a\u4e00\u9875", first_on: !0, last_on: !0, next_on: !0, prev_on: !0, links: "#", tipInfo_on: !1, tipInfo: "<span>&nbsp;&nbsp;\u8df3{currText}/{sumPage}\u9875</span>", tipInfo_css: {width: "22px"}, tipSelect_on: !1, tipSelect: "\u8df3\u8f6c\u5230{select} \u5171{sumPage}\u9875"}}, opts = $.extend(!0, defaults, param);
