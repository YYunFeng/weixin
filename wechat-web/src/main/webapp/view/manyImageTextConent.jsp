...
<h3 class="page-sub-hd">多图文列表&nbsp;(共 <s:property value="materialListResList.size()"/> 个)</h3>
    ...
    <div class="tj msg-list">
        <div id="first_col" class="b-dib vt msg-col">
            <div id="addAppmsg" class="tc add-access">
                <span class="dib vm th add-tip" style="cursor: pointer;" onclick="addManyImageText();">新建消息入口</span>
            </div>
                            ...
                            <div id="appmsgItem1" class="msg-item appmsgItem">
                                <h4 class="msg-t">
                                    ...
                                    <span style="color:#73ae1f;">(共<b><s:property
                                            value="manyImageTextCount"/></b>张图文)</span>
                                </h4>
                                ...
                                <ul class="f0 msg-opr-list">
                                    <li class="b-dib opr-item">
                                        <a class="block tc opr-btn edit-btn"
                                           href="javascript:modifyManyImageText(<s:property value="Id"/>)">
                                            <span class="th vm dib opr-icon edit-icon">编辑</span>
                                        </a>
                                    </li>
                                    <li class="b-dib opr-item">
                                        <a class="block tc opr-btn del-btn"
                                           href="javascript:deleteMaterial(<s:property value="Id"/>,1);"
                                           data-mid="10000014">
                ...
                <s:if test="#material.even">
                    <div class="msg-item-wrapper" id="appmsg10000009" data-appid="10000009"
                        ...
                        <div class="msg-item appmsgItem">
                            <h4 class="msg-t"><s:property value="title"/> <span style="color:#73ae1f;">(共<b><s:property
