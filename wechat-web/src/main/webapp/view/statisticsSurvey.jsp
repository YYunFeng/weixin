...
<s:iterator value="statisticsResList">
    ...
    <div class="list_title_c">
        ...
        <div class="list_title_c_r ltcr1">
            <div class="s1"><a style="cursor: pointer" onclick="statisticsJS.btn_listhidden('<s:property value="surveyId"/>', 1,2)">查看详情</a></div>
        </div>
    ...
    <div class="clr"></div>
    <div class="list_detail" id="<s:property value="surveyId"/>" style="display:none;">
    </div>
    <!--统计列表 for循环_end-->
</s:iterator>