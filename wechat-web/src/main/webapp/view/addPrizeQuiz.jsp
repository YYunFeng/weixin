...
<script type="text/javascript" src="/js/toolPrizeQuiz.js"></script>
...
<div class="page-bd">
    <div class="tj msg-list">
        <div id="first_col1" class="b-dib vt msg-col">
            <div class="msg-item-wrapper" data-appid="10000014" data-create-time="2013-04-16">
                <div class="msg-item appmsgItem">
                    <h4 class="msg-t"><a class="i-title" id="moduletitleM">有奖竞答</a></h4>
                    ...
                    <div class="cover">
                        ...
                        <img src="../images/prizequiz.jpg"
                             class="i-img" style="" id="previewPic">
                        <input type="hidden" value="prizequiz.jpg" id="bigWheelPic"/>
                    </div>
        ...
        <div class="b-dib vt msg-col" style="">
            ...
            <p class="p_new">
                <font>标题</font>
                <input type="text" placeholder="请输入标题" id="title" value="有奖竞答"/>
            </p>
            ...
            <div>
                <div class="p_new_btn_l p_new_btn_hover" id="updata_img_btn_d" style="cursor: pointer"
                     onclick="javascript:(function(){toolPrizeQuiz.moduleUpdateimg('d');jQuery('#upload_block').hide();})()">
                    默认封面
                </div>
                <div class="p_new_btn_r" id="updata_img_btn_u" style="cursor: pointer"
                     onclick="javascript:(function(){toolPrizeQuiz.moduleUpdateimg('u');jQuery('#upload_block').show();})()">
                    自定义封面
                </div>
                <div class="clear"></div>
            </div>
            ...
            <p class="p_new">
                <font>摘要</font>
                <textarea placeholder="请输入摘要" id="surveyContent"></textarea>
            </p>
        </div>
        ...
        <div class="b-dib vt msg-col" style="">
            <%-- <p class="p_new">
                 ...
                 <!--中奖设置_Begin-->
             <ul>
                 <li><input id="award_1" type="radio" name="award" onclick="type_hide()"/>
                     <label for="award_1" onclick="">有奖竞答</label></li>
                 <li><input id="award_2" type="radio" name="award" onclick="type_show()" checked="checked"/>
            ...
            <%--   <p class="p_new" id="probabilityShow">
                   <font>中奖概率</font>
                   <input placeholder="请输入中奖概率" id="probability" type="text"/>
               </p>
   --%>
            <p class="p_new">
                <font>奖项总数</font>
                <input placeholder="请输入奖项总数" id="count" type="text"/>
            </p>
        </div>
        <div class="b-dib" style="width:100%;height:0;overflow:hidden;font-size:0;"></div>
    </div>
    <p class="tc msg-btn">
        <a href="javascript:void(0);" id="save" class="btnGreen" onclick="toolPrizeQuiz.savePrizeQuiz();">完成</a>
    </p>
</div>
<div class="clr"></div>
