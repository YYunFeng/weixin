...
<h3 class="page-sub-hd">大转盘列表&nbsp;(共 <s:property value="componentList.size()"/> 个)</h3>
    ...
    <div class="tj msg-list">
        <div id="first_col" class="b-dib vt msg-col">
            <div id="addAppmsg" class="tc add-access">
                <span class="dib vm th add-tip" style="cursor: pointer;" onclick="addBigWheelComponent();">新建消息入口</span>
            </div>
                                ...
                                <ul class="f0 msg-opr-list">
                                    <li class="b-dib opr-item">
                                        <a class="block tc opr-btn edit-btn"
                                           href="javascript:modifyBigWheel(<s:property value="Id"/>)">
                                            <span class="th vm dib opr-icon edit-icon">编辑</span>
                                        </a>
                                    </li>
                                    <li class="b-dib opr-item">
                                        <a class="block tc opr-btn del-btn"
                                           href="javascript:deleteBigWheelComponent(<s:property value="Id"/>);"
                                           data-mid="10000014">
