...
<head>
    ...
    <script type="text/javascript" src="/js/toolScratch.js"></script>
    <link href="../css/menu.css" rel="stylesheet" type="text/css">
    <link href="../css/public.css" rel="stylesheet" type="text/css">
    <link href="../css/operate_appmsg.css" rel="stylesheet" type="text/css">
    <link href="../css/cards_appmsg_change.css" rel="stylesheet" type="text/css">
</head>
            ...
            <div class="sideBar">
                <div class="catalogList">
                    <ul>
                        ...
                        <li id="scratchCard" class="selected"><a href="/component/scratchCard.action">刮刮卡</a></li>
