...
<div class="page-bd">
    ...
    <p class="tc msg-btn">
        <a href="javascript:void(0);" id="save" class="btnGreen" onclick="toolPrizeQuiz.modifyPrizeQuiz(<s:property value="surveyRes.componentId"/>,<s:property value="surveyRes.surveyId"/>);">完成</a>
    </p>
</div>
<div class="clr"></div>
