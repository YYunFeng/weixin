        ...
        function _loading(statusTemp) {
            ...
            if (_s == 0) { // 关
                ...
                with (loading_bg.style) {
                    ...
                    bottom = "0px";
                    left = "0px";
                    backgroundImage = "url(jstool/bg.png)";
                }
...
//		setTimeout(_loading, 1000)
        ...
        function _alertAuto(statusTemp, tTemp, isClick, clickFun) {
...
//				minHeight = "200px";
//				background = "#fff";
                    backgroundImage = "url(jstool/bg.jpg)";
...
//				backgroundImage = "url(jstool/bg.jpg)";
                ...
                btndiv.innerHTML = "跳转到中奖页面"
                btndiv.onclick = function () {
                    clickFun();
                }
                if (isClick == 1) {
                    alert_bg.appendChild(btndiv);
                }
...
//		setTimeout(_loading, 1000)
        ...
        return {
            loading: _loading, loadingHTML5: _loadingHTML5, loadingremove: _loadingremove, alertAuto: _alertAuto, alertremove: _alertremove, getWordsNum: _getWordsNum, trim: _trim, ltrim: _ltrim, rtrim: _rtrim
        }
