    ...
    <div class="left msg-preview">
        <div class="msg-item-wrapper" id="appmsg" data-appid="" data-create-time="2013-04-18">
            <div id="appmsgItem1" class="msg-item appmsgItem sub-msg-opr-show">
                <h4 class="msg-t"><span class="i-title" id="titleM"><s:property value="materialRes.picMessage.title"/></span></h4>
                <s:bean var="now" name="java.util.Date"/>
                <p class="msg-meta"><span class="msg-date"><s:date name="#now" format="yyyy-MM-dd"/></span></p>

                <div class="cover">
                    <p class="default-tip" id="picTitle" style="display:none;">封面图片</p>
                    <img src="<s:property value="materialRes.picMessage.visitUrl"/>" class="i-img" id="previewPic">
                </div>
                <p class="msg-text" id="descM"><s:property
                        value="materialRes.picMessage.abstractContent"/></p>
            </div>
        ...
        <div class="rel msg-editer-wrapper">
            <div class="msg-editer">
                <div>
                    ...
                    <input type="text" class="msg-input" id="title"
                           value="<s:property value="materialRes.picMessage.title"/>">
                    ...
                    <div>
                        <div class="oh z cover-hd">
                            ...
                            <input type="hidden" id="singleImagePic"
                                   value="<s:property value="materialRes.picMessage.picUrl"/>"/>
                        </div>
                        <div id="fileQueue" style="width:242px;"></div>

                    </div>
                    <a id="desc-block-link" style="padding-top: 10px;<s:if test="materialRes.picMessage.abstractContent!=null&&materialRes.picMessage.abstractContent!=''">display: none;</s:if>"
                       href="javascript:(function(){jQuery('#desc-block').show();jQuery('#desc-block-link').hide()})()"
                       class="url-link block" >添加摘要</a>

                    <div id="desc-block" class="none"
                            <s:if test="materialRes.picMessage.abstractContent!=null&&materialRes.picMessage.abstractContent!=''"> style="display: block;"</s:if><s:else>style="display: none;"</s:else>>
                        <label class="block">摘要</label>
                        <textarea name="" id="desc" class="msg-txta"><s:property
                                value="materialRes.picMessage.abstractContent"/></textarea>
                    </div>
                </div>
                <label class="block">正文</label>
                <textarea class="msg-txta" style="height:320px;" id="contentTextarea"><s:property
                        value="materialRes.picMessage.message"/></textarea>
            ...
            <p class="tc msg-btn">
                <a href="javascript:;" id="save" class="btnGreen" onclick="finish_operate_modifyJS(<s:property
                        value="materialRes.picMessage.Id"/>)">完成</a>
            </p>
        </div>
