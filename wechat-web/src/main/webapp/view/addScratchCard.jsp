...
<div class="page-bd">
    <div class="tj msg-list">
        <div id="first_col1" class="b-dib vt msg-col">
            <div class="msg-item-wrapper" data-appid="10000014" data-create-time="2013-04-16">
                <div class="msg-item appmsgItem">
                    <h4 class="msg-t"><a href="#" class="i-title" target="_blank" id="moduletitleM">刮刮卡</a></h4>
                    ...
                    <div class="cover">
                        ...
                        <img src="../images/scaratch.jpg"
                             class="i-img" style="" id="previewPic">
                        <input type="hidden" value="scaratch.jpg" id="bigWheelPic"/>
                    </div>
        ...
        <div class="b-dib vt msg-col" style="">
            ...
            <p class="p_new">
                <font>标题</font>
                <input type="text" placeholder="请输入标题" id="moduletitle" value="刮刮卡"/>
            </p>
                    ...
                    <div>
                        ...
                        <div class="contentclass1">
                            <div class="content_block">
                                <div><b>一等奖</b>：<span id="moduleprize1M"></span>（<span id="moduleprize1NumM"> </span>名）</div>
                                <div><b>二等奖</b>：<span id="moduleprize2M"></span>（<span id="moduleprize2NumM"> </span>名）</div>
                                <div><b>三等奖</b>：<span id="moduleprize3M"></span>（<span id="moduleprize3NumM"> </span>名）</div>
                            </div>

                            <div class="content_block">
                                <div id="moduleprizeContentM">&nbsp;</div>
                                <div style="display:none;">每名参与者最多可以抽取 <b id="moduleExtractionNumM"></b> 次</div>
                            </div>
    ...
    <p class="tc msg-btn">
        <a href="javascript:void(0);" id="save" class="btnGreen" onclick="toolScratch.moduleFinish()">完成</a>
    </p>
</div>
<div class="clr"></div>
