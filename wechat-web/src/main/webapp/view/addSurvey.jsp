...
<div class="page-bd">
    <div class="tj msg-list">
        <div id="first_col1" class="b-dib vt msg-col">
            <div class="msg-item-wrapper" data-appid="10000014" data-create-time="2013-04-16">
                <div class="msg-item appmsgItem">
                    <h4 class="msg-t"><a class="i-title" id="moduletitleM">问卷调查</a></h4>
                    ...
                    <div class="cover">
                        ...
                        <input type="hidden" value="survey.jpg" id="bigWheelPic"/>
                    </div>
        ...
        <div class="b-dib vt msg-col" style="">
            ...
            <p class="p_new">
                <font>标题</font>
                <input type="text" placeholder="请输入标题" id="title" value="问卷调查"/>
            </p>
    ...
    <p class="tc msg-btn">
        <a href="javascript:void(0);" id="save" class="btnGreen" onclick="toolSurvey.saveSurvey();">完成</a>
    </p>
</div>
<div class="clr"></div>
